...
#
# Vendored from ultralytics/nn/modules/conv.py and ultralytics/nn/modules/block.py.
# Building blocks for the YOLO26 backbone/neck (Conv, C3k2/C3k/C2f, SPPF, C2PSA,
# Bottleneck, PSABlock/Attention, Concat), plus the make_divisible/autopad helpers
# used to build them. Original Ultralytics copyright and license retained, only
# the classes this project actually uses were kept, everything else (Segment/Pose/
# OBB/RTDETR-specific modules etc.) was left out.
#
...
def make_divisible(x: int, divisor: int | torch.Tensor) -> int:
